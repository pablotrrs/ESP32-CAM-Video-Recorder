...
<body style="font-family: Arial, sans-serif; text-align: center; background-color: #f0f0f0; margin: 0; padding: 20px;">
<h1 style="color: #333333;">%s<br>ESP32-CAM Video Recorder %s<br><span style="color: red;">%s</span></h1><br>
<p style="font-size: 18px; color: #555555;">Used <span style="color: red;">%d MB</span> of <span style="color: red;">%d MB</span> total SD space</p>
<p style="font-size: 16px; color: #555555;">Rssi %d</p>

<p style="font-size: 16px; color: #555555;">Filename is '%s'</p>
<p style="font-size: 16px; color: #555555;">Framesize %d - Quality %d - Frame %d</p>
<p style="font-size: 16px; color: #555555;">Avg frame size %d - FPS %.1f</p>
<p style="font-size: 16px; color: #555555;">Time left in current video %d s</p>
<br>
<p style="font-size: 16px; color: #555555;">Use below links to navigate</p>
<h3 style="text-decoration: none; color: #007bff;"><a href="http://%s/">http://%s/</a></h3>
<h3><a href="http://%s/stream" style="text-decoration: none; color: #007bff;">Stream</a></h3>
<h3><a href="http://%s/photos" style="text-decoration: none; color: #007bff;">Photos (10 saveable photos every 3s)</a></h3>
<h3><a href="http://%s:%d" style="text-decoration: none; color: #007bff;">File Manager (download, delete & edit)</a></h3>
<h3></h3>
<h3><a href="http://%s/reboot" style="text-decoration: none; color: #007bff;">End recording & reboot</a></h3>
</body>
</html>)rawliteral";
